...
export default function Tutorial() {
  return (
    <div className="tile is-ancestor">
      <div className="tile is-parent is-vertical mr-3">
        ...
        <article className="tile is-child notification is-light">
          <div className="columns">
            <div className="column tile is-parent is-vertical is-4">
              <figure className="tile is-child image is-5by3 mb-1">
                <img src={require("../../images/new_playlist.png")} alt="" />
              </figure>

              <figure className="tile is-child image is-5by3">
            ...
            <div className="column is-size-5 has-text-left">
              ...
              <p className="is-italic mb-4">
                To do this, in the Desktop App, go to your 'Liked Songs'
                playlist, click the top song, then click 'Ctrl + A' (Cmd on Mac)
                and all your songs should now be selected. Now, right click any
                song, then click 'Add to Playlist', then 'New Playlist'.
              </p>
              <p className="mb-4">
              ...
              <p className="is-italic">
                Keep in mind your friends will also need to to this so we can
                find their music to compare as well!
              </p>
            </div>
          </div>
        </article>
